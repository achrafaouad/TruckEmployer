...
public class map extends AppCompatActivity implements OnMapReadyCallback,
    ...
    public void onMapReady(GoogleMap map) {
        ...
        MarkerOptions markerOptions = new MarkerOptions().position(position).title("Hi my name is soufian");
    ...
    public void add_data(int i){
        ...
        hashMap.put("Current Position",latutude+"," +longitude);
        mdatabase.child("user_"+i).child("Mission").setValue(hashMap);
