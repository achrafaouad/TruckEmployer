...
public class mapAdmin extends AppCompatActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        firstName=intent.getStringExtra("tache");
        tache1=intent.getStringExtra("tache");
        id=intent.getStringExtra("user_id");
        nom =(TextView) findViewById(R.id.Nom);
        prenom = (TextView) findViewById(R.id.prenom);
        tache = (TextView) findViewById(R.id.Tach);
        prenom.setText(firstName);
        nom.setText(lastName);
        tache.setText(tache1);
    ...
    public void onMapReady(GoogleMap map) {
        ...
        map.addMarker(markerOptions);
            mdatabase.child("User_"+id).child("current_position").addValueEventListener(new ValueEventListener() {
                @Override
                public void onDataChange(@NonNull DataSnapshot snapshot) {
                                ...
                                MarkerOptions markerOptions1 = new MarkerOptions().position(position_emp).title("Hi my name is" + lastName);
